...
export { ReactComponent as DefaultImg } from './default_img.svg';
...
export { ReactComponent as Splash } from './splash.svg';
export { ReactComponent as NoDataDetail } from './nodata.svg';
